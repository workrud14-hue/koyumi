          ...
          <>
            ...
            <div className="mt-10">
              <button
                ...
                disabled={loading}
                className="flex w-full items-center justify-center gap-3 border border-outline-variant/40 bg-white py-3.5 font-mono text-xs font-bold tracking-[0.1em] text-void transition-all hover:bg-gray-50 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] disabled:opacity-50"
              >
                <GoogleIcon />
